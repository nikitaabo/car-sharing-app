...
public class CarServiceTestUtil {
    public static CreateCarRequestDto getCarRequestDto(String brand, String model, Car.CarType type,
    ...
    public static Car getCar(String brand, String model, Car.CarType type,
                             int inventory, BigDecimal dailyFee) {
        Car car = new Car();
        car.setBrand(brand);
        car.setModel(model);
    ...
    public static CarDto getCarDto(Long id, String brand, String model, Car.CarType type,
                                   int inventory, BigDecimal dailyFee) {
    ...
    public static List<Car> getCars() {
        ...
        Car car2 = getCar("Audi", "Q7",
                Car.CarType.SEDAN, 10, BigDecimal.valueOf(60));
